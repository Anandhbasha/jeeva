...
// // // promise
// // const todayClass = new Promise((resolved,rejected)=>{
// //     const Tclass = false
// //     console.log(Tclass);
    
// //     if(Tclass){
// //         resolved("Today class is avalible")
// //     }
// //     else{
// //         rejected("Today No class")
// //     }
// // })

// // todayClass.then((res)=>console.log(res)).catch((err)=>console.log(err))
...
// switch(answer){
//     case "KKR":
//         console.log("KKR won the match");
//         break
//     case "CSK":
//         console.log("CSk Won the match");    
//         break
//     case "RR":
//         console.log("RR Won");
//         break
...
// }
// Destructure
// let arr = [1189,1187,1185,1180,1179,1179,1178,1176]
// let arr1 = [1159,1157,1155,1150,1179,1179,1175,1176]
// // ...others rest ope
// let [first,second,...others] = arr
// console.log(first,second);
// console.log(others);

// let allMarks = [...arr,...arr1]
